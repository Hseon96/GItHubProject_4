...
public class RecipeMain {
	...
	public ArrayList<RecipeVO> recipeAllData()
	{
	     ArrayList<RecipeVO> rlist=
	     ...
	     try
	     {
	    	 ...
	    	 FileOutputStream fos=
	    			 new FileOutputStream("c:\\java_data\\recipe.txt");
	...
	public static void main(String[] args) throws Exception{
		...
		ArrayList<RecipeDetailVO> rList=
				new ArrayList<RecipeDetailVO>();
		ArrayList<RecipeVO> list=rm.recipeAllData();
		...
		{
			FileOutputStream fos=
					new FileOutputStream("c:\\java_data\\recipe_detail.txt");
